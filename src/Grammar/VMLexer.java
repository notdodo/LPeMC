		...
		public int specialStateTransition(int s, IntStream _input) throws NoViableAltException {
			...
			switch ( s ) {
					case 0 : 
						...
						else if ( (LA8_0=='h') ) {s = 10;}
						else if ( (LA8_0==':') ) {s = 11;}
						else if ( ((LA8_0 >= 'A' && LA8_0 <= 'Z')||(LA8_0 >= 'e' && LA8_0 <= 'g')||LA8_0=='i'||LA8_0=='k'||(LA8_0 >= 'n' && LA8_0 <= 'o')||(LA8_0 >= 'q' && LA8_0 <= 'r')||(LA8_0 >= 't' && LA8_0 <= 'z')) ) {s = 12;}
						else if ( (LA8_0=='0') ) {s = 13;}
						else if ( (LA8_0=='-') ) {s = 14;}
						else if ( ((LA8_0 >= '1' && LA8_0 <= '9')) ) {s = 15;}
						else if ( ((LA8_0 >= '\t' && LA8_0 <= '\n')||LA8_0=='\r'||LA8_0==' ') ) {s = 16;}
						else if ( (LA8_0=='/') ) {s = 17;}
						else if ( ((LA8_0 >= '\u0000' && LA8_0 <= '\b')||(LA8_0 >= '\u000B' && LA8_0 <= '\f')||(LA8_0 >= '\u000E' && LA8_0 <= '\u001F')||(LA8_0 >= '!' && LA8_0 <= ',')||LA8_0=='.'||(LA8_0 >= ';' && LA8_0 <= '@')||(LA8_0 >= '[' && LA8_0 <= '`')||(LA8_0 >= '{' && LA8_0 <= '\uFFFF')) ) {s = 18;}
						if ( s>=0 ) return s;
						break;
			}
			NoViableAltException nvae =
